...
(async function(){
  ...
  const scripts=[['head-cleanup.js?v=2','headCleanup'],['profile-fix.js?v=4','profileFix'],['wallet-fix.js?v=1','walletFix'],['home-dashboard.js?v=9','homeDashboard'],['interaction-fix.js?v=2','interactionFix'],['competition-fix.js?v=1','competitionFix'],['league-sponsor.js?v=2','leagueSponsor'],['launch-safety.js?v=1','launchSafety'],['transfer-safety.js?v=3','transferSafety'],['admin-guard.js?v=1','adminGuard'],['startup-recovery.js?v=1','startupRecovery']];
