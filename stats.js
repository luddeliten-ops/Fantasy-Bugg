...
(async function(){
  ...
  if(!document.querySelector('link[data-page-heroes]')){const style=document.createElement('link');style.rel='stylesheet';style.href='page-heroes.css?v=3';style.dataset.pageHeroes='1';document.head.appendChild(style);}
  ...
  const scripts=[['head-cleanup.js?v=2','headCleanup'],['profile-fix.js?v=4','profileFix'],['wallet-fix.js?v=1','walletFix'],['home-dashboard.js?v=9','homeDashboard'],['interaction-fix.js?v=2','interactionFix'],['competition-fix.js?v=1','competitionFix'],['league-sponsor.js?v=2','leagueSponsor'],['launch-safety.js?v=1','launchSafety'],['transfer-safety.js?v=3','transferSafety'],['admin-guard.js?v=1','adminGuard'],['startup-recovery.js?v=1','startupRecovery'],['registered-players.js?v=1','registeredPlayers'],['team-remove-v2.js?v=1','teamRemoveV2'],['team-privacy.js?v=1','teamPrivacy']];
