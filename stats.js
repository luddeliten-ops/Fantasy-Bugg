...
(async function(){
  ...
  const scripts=[['head-cleanup.js?v=1','headCleanup'],['profile-fix.js?v=4','profileFix'],['home-dashboard.js?v=8','homeDashboard'],['interaction-fix.js?v=2','interactionFix'],['competition-fix.js?v=1','competitionFix'],['league-sponsor.js?v=2','leagueSponsor'],['launch-safety.js?v=1','launchSafety']];
