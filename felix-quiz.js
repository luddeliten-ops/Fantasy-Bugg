...
(() => {
  ...
  function mount() {
    ...
    root.innerHTML = '<div class="panel" style="max-width:850px;margin:auto"><h1>💃 Felix Bugg Quiz</h1><p>10 frågor om tävling, SM och buggens historia. Flest rätt vinner, snabbast tid avgör vid lika poäng.</p><p><strong>🏆 Priser:</strong> De som slutar på pallplats (plats 1–3) vinner fantasypoäng!</p><p style="padding:12px 14px;border:2px solid #d6a83e;border-radius:10px"><strong>⏰ Sista tävlingsdag: lördag 26 september 2026, kl. 23.59.</strong></p><div id="felixWelcome"><button class="btn gold" id="felixStart">Starta quiz</button></div><div id="felixPlay" hidden><p id="felixClock">Tid: 0:00</p><form id="felixForm"></form></div><div id="felixResult" role="status"></div></div>';
