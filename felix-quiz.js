...
(() => {
  const questions = [
    ...
    ['Vilket år bytte man från 2-minutersheat till 90-sekundersheat i Bugg?', ['2002','2001','2003','2004']],
  ...
  const explanations = [
    ...
    ['2002','År 2002 ändrades heaten från två minuter till 90 sekunder.'],
