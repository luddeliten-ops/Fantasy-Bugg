...
(() => {
  ...
  function mount() {
    ...
    root.innerHTML = '<div class="panel" style="max-width:850px;margin:auto"><h1>💃 Felix Bugg Quiz</h1><p>10 frågor om tävling, SM och buggens historia. Flest rätt vinner, snabbast tid avgör vid lika poäng.</p><p><strong>🏆 Priser:</strong> De som slutar på pallplats (plats 1–3) vinner fantasypoäng!</p><div id="felixWelcome"><button class="btn gold" id="felixStart">Starta quiz</button></div><div id="felixPlay" hidden><p id="felixClock">Tid: 0:00</p><form id="felixForm"></form></div><div id="felixResult" role="status"></div></div>';
